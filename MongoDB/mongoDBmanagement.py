...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            self.url = "mongodb+srv://{}:{}@testcluster.fjvlj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"\
    ...
    def getDatabase(self, db_name):
        ...
        try:
            ...
            raise Exception(f"(getDatabase): Failed to get the database list. Because of " + str(e))
    ...
    def getCollection(self, collection_name, db_name):
        ...
        try:
            ...
            raise Exception(f"(getCollection): Failed to get the database list. Because of" + str(e))
    ...
    def dropCollection(self, collection_name, db_name):
        ...
        try:
            ...
            raise Exception(f"(dropCollection): Failed to drop collection {collection_name}" + str(e))
    ...
    def updateMultipleRecord(self, db_name, collection_name, query):
        ...
        try:
            ...
            raise Exception(f"(updateMultipleRecord): "
                            f"Failed to update the records with given collection query or database name.\n" + str(e))
